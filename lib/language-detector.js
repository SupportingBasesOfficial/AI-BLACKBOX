...
function hasFilesMatchingGlob(cwd, pattern) {
  ...
  if (pattern === "*.kt" || pattern === "*.kts") {
    return checkDirForExt(cwd, ".kt", 2) || checkDirForExt(cwd, ".kts", 2);
  }
  if (pattern === "*.scala") {
    return checkDirForExt(cwd, ".scala", 2);
  }
  if (pattern === "*.groovy") {
    return checkDirForExt(cwd, ".groovy", 2);
  }
  if (pattern === "*.rb") {
    return checkDirForExt(cwd, ".rb", 2);
  }
  return false;
}
...
export const LANGUAGE_TOOLS = {
  ...
  kotlin: { typeCheck: "kotlinc", lint: "ktlint", test: "kotest", propertyTest: "kotest-property", mutation: "pitest" },
  scala: { typeCheck: "scalac", lint: "scalafmt", test: "scalatest", propertyTest: "scalacheck", mutation: "stryker4s" },
  groovy: { typeCheck: null, lint: "codenarc", test: "spock", propertyTest: null, mutation: null },
  csharp: { typeCheck: "dotnet build", lint: "roslyn", test: "xunit", propertyTest: "fscheck", mutation: "stryker-net" },
  ruby: { typeCheck: "sorbet", lint: "rubocop", test: "rspec", propertyTest: "rantly", mutation: "mutant" },
  php: { typeCheck: "phpstan", lint: "php-cs-fixer", test: "phpunit", propertyTest: "eloquent", mutation: "infection" },
  swift: { typeCheck: "swiftc", lint: "swiftlint", test: "xctest", propertyTest: "swiftcheck", mutation: "mull" },
  dart: { typeCheck: "dart analyze", lint: "dart format", test: "flutter test", propertyTest: "dart_property", mutation: "mutest" },
  cpp: { typeCheck: "g++", lint: "clang-tidy", test: "gtest", propertyTest: null, mutation: "mull" },
  c: { typeCheck: "gcc", lint: "clang-tidy", test: "unity", propertyTest: null, mutation: "mull" },
  elixir: { typeCheck: "dialyzer", lint: "credo", test: "exunit", propertyTest: "stream_data", mutation: "muzak" },
};
